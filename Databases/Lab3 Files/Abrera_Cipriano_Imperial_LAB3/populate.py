...
if __name__ == '__main__':
    ...
    order.checkout("aarchamb", "home", shopping_cart1, '2000-09-11')
    order.checkout("tgrimes1", "home", shopping_cart2, '2000-07-11')
    order.checkout("tgrimes1", "home", shopping_cart3, '2000-12-11')